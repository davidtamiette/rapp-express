...
const FloatingDeadlineBanner = () => {
  ...
  return (
    <div
      className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${isScrolled ? "shadow-md py-2" : "py-3"
    ...
    >
      <div className="container px-4 flex items-center justify-center gap-2 sm:gap-4 flex-wrap">
        <div className="flex items-center gap-2 font-semibold text-sm sm:text-base">
          ...
          <span>Prazo do RAPP: 1º de fevereiro a 31 de maio</span>
        </div>
